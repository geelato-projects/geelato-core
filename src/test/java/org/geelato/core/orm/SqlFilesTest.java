...
public class SqlFilesTest {
    ...
    public void parseLine() {
        String line1 = "insert into platform_city(id, creator, create_at, updater, update_at, description, check_state,code, name, province_code) values ($newId(), 1, NOW(), 1, NOW(),'',0,'630100', '西宁市', '630000');";
...
//        System.out.println("parseLine>无空格$newId()>" + newLine1);
        ...
        String line2 = "insert into platform_city(id, creator, create_at, updater, update_at, description, check_state,code, name, province_code) values ($newId  (  ), 1, NOW(), 1, NOW(),'',0,'630100', '西宁市', '630000');";
